    ...
    def compute_new_velocity(self):
        ...
        for dist_sq, obstacle1 in self.obstacle_neighbors:
            ...
            if s < 0.0 and dist_sq_line <= radius_sq:
                ...
                # The agent too close to the line, so that it can only collide with left vertex.
                ...
                # Say the angle between relative_position1 and the leg is theta
                # Then, sin(theta) = radius / sqrt(dist_sq1), cos(theta) = leg / sqrt(dist_sq1)
                # x component: relative_position1.x * cos(theta) - relative_position1.y * sin(theta)
                # y component: relative_position1.x * sin(theta) + relative_position1.y * cos(theta)
                ...
                # The agent too close to the line, so that it can only collide with right vertex.
